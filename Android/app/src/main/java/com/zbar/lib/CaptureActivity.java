			...
			public void onSuccess(String result) {
				try {
					...
					if (jsonObject.getInt("code") == 1) {
						...
						note.setDetailUrl(jsonObject.getString("detail_url"));
						/*note.setReadNum(Integer.parseInt(jsonObject.getString("read_nums")));
						note.setEndDate(jsonObject.getString("end_date"));
						note.setEndTime(jsonObject.getString("end_time"));
						note.setTitle(jsonObject.getString("title"));
						note.setImgUrl(jsonObject.getString("img_url"));
						note.setStartTime(jsonObject.getString("start_time"));
						note.setStartDate(jsonObject.getString("start_date"));
						note.setOrganizer(jsonObject.getString("organizer"));
						note.setType(jsonObject.getString("type"));*/
